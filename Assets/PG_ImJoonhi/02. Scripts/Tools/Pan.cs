...
public class Pan : Item, IPunObservable
{
    ...
    {
        if (!Cooking && ingredient.ingredientsData.Paned != null && ingredient.IngState != IngredientState.Paned && ingredient.IngState == IngredientState.Sliced && CookingObject == null)
        {
            // OnPan(ingredient);
